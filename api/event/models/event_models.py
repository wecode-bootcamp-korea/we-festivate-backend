...
class EventPost(models.Model):
    ...
    event_page_url = models.URLField(max_length=100, default="members.wework.com")      # members.wework.com 에 올려져있는 이벤트 url 링크
    main_text = models.TextField(max_length=2000 ,blank=True, default="준비 중 입니다.")   # 본문 내용
